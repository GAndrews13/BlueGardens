...
public class DummyData {
	...
	public DummyData() {
		product1 = new Product(1, "Ketchup", 10, 3, 10, false, 135.00, false,
				"that's", "ammmaaaazing", "that", "you", "know",
				"resources/img/ketchup.png", true);

		product2 = new Product(2, "Chocolate", 100, 30, 100, false, 10.00,
		...
		product4 = new Product(4, "Floor", 100, 70, 700, true, 98.00, false,
				"that's", "ammmaaaazing", "that", "you", "know",
		...
		product7 = new Product(7, "Cheese", 150, 13, 163, false, 12.00, true,
				"that's", "ammmaaaazing", "that", "you", "know",
				"resources/img/cheese.png", false);

		product8 = new Product(8, "Sofa", 140, 36, 164, false, 700.00, true,
				"that's", "ammmaaaazing", "that", "you", "know",
		...
		customer1 = new Customer(1, "Oliver", "Queen",
				"Queen Mansion, Starling City, OL1 V3R", "999",
