 ...
 *  graphical window using swing for the warehouse order tracking system
 */
		  ...
		  loginItem.addActionListener(new ActionListener() 
		  {
			 @Override
			  public void actionPerformed(ActionEvent e)
			  {
				...
				workerID = Integer.parseInt(JOptionPane.showInputDialog(mainFrame,"Please enter your worker ID",null));
				password = (JOptionPane.showInputDialog(mainFrame, "Enter your password", null));
