...
public class Supplier {
	...
	/**
	 * @author lczornyj Create the variables for the supplier
	 */
	...
	/**
	 * @author lczornyj Create getters and setters for the variables except ID
	 *         as there is no need to set a ID as it will be automatically
	 *         generated
	 * @return
	 */
	public Supplier() {
