...
public class WarehouseWorker {
	...
	public String getAddress() { return workerAddress; }
	public int getWorkerId() { return workerId; }
	public boolean isAssigned() { return isAssigned; }
	
	public void setName(String workerName) { this.workerName = workerName; }
	public void setAddress(String workerAddress) { this.workerAddress = workerAddress; }
