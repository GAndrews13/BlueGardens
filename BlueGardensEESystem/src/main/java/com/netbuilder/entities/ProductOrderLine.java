...
/**
 * @author Jake Product Order Line entity
 */
@Entity
@Table(name = "Product Order Line")
@NamedQueries({
		// @NamedQuery(name = Customer.FIND_BY_NAME , query =
...
public class ProductOrderLine {
	...
	/**
	 * @author Jake Attributes of the Product Order Line including unique
	 *         identifier and the quantity of the products
	 */
