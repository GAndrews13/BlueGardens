...
public class ProductOfIntrestLists implements Serializable {
	/**
	 * Serialized the POI and passed them as strings so that they can be
	 * contained within an object ready for the message sender to send the
	 * message.
	 * 
	 * @author lczornyj
	 */
	...
	public ProductOfIntrestLists(ArrayList<Product> sale,
			ArrayList<Product> pourous, ArrayList<Product> trending) {
		this.sale = sale;
	...
	public String toString() {
		return "ProductOfIntrestLists [sale=" + sale.toString() + ", pourous="
				+ pourous.toString() + ", trending=" + trending.toString()
				+ "]";
	}
}