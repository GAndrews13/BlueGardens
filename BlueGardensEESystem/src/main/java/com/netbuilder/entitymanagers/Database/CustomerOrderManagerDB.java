...
public class CustomerOrderManagerDB implements CustomerOrderManager {
	...
	public CustomerOrder findByCustomerOrderId(int customerOrderId) {
		EntityManager em = pm.CreateEntityManager();
		TypedQuery<CustomerOrder> tq = em.createNamedQuery(
				CustomerOrder.FIND_BY_CUSTOMER_ORDER_ID, CustomerOrder.class);
		pm.CloseEntityManager(em);
	...
	public ArrayList<CustomerOrder> findByisAssigned(boolean isAssigned) {
		...
		co = (ArrayList<CustomerOrder>) em.createQuery(
				"SELECT * FROM CustomerOrder WHERE Is_Assigned = isAssigned ",
	...
	public CustomerOrder findByTrackingId(int trackingId) {
		EntityManager em = pm.CreateEntityManager();
		TypedQuery<CustomerOrder> tq = em.createNamedQuery(
				CustomerOrder.FIND_BY_TRACKING_ID, CustomerOrder.class);
		pm.CloseEntityManager(em);
	...
	public ArrayList<CustomerOrder> findByDeliveryType(String deliveryType) {
		...
		co = (ArrayList<CustomerOrder>) em
				.createQuery(
						"SELECT * FROM CustomerOrder WHERE DeliveryType = deliveryType",
						CustomerOrder.class).getResultList();
	...
	public ArrayList<CustomerOrder> findByCustomer(long customerID) {
		...
		co = (ArrayList<CustomerOrder>) em
				.createQuery(
						"SELECT * FROM CustomerOrder WHERE Customer.CustomerID = customerID ",
						CustomerOrder.class).getResultList();
	...
	public ArrayList<CustomerOrder> findByWorker(long workerID) {
		...
		co = (ArrayList<CustomerOrder>) em
				.createQuery(
						"SELECT * FROM CustomerOrder WHERE WarehouseWorker.WorkerId = workerID ",
						CustomerOrder.class).getResultList();
	...
	public ArrayList<CustomerOrder> findByDeliveryStatus(DeliveryStatus status) {
		...
		co = (ArrayList<CustomerOrder>) em.createQuery(
				"SELECT * FROM CustomerOrder WHERE DeliveryStatus = status ",
				CustomerOrder.class).getResultList();
