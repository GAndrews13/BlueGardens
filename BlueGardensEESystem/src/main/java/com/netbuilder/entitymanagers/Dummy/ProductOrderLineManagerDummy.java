...
/**
 * @author Jake Dummy class for testing the product order line
 */
@Alternative
public class ProductOrderLineManagerDummy implements ProductOrderLineManager {
	/**
	 * @author Jake product order line array instead of a database Create a new
	 *         product order line
	 */
	...
	/**
	 * @author Jake Find a product order line using its ID
	 */
	...
	/**
	 * @author Jake Find a product order line using the product ID
	 */
	...
	/**
	 * @author Jake Return array of product order lines that are below a certain
	 *         quantity
	 */
	...
	/**
	 * @author Jake Edit product order line with new information
	 */
